...
//                i.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(output));
    ...
    private void CallRegisterAPI() {
        ...
        if (App.Utils.IsInternetOn()) {
            ...
            params.put(Constants.password, RequestBody.create(MediaType.parse("multipart/form-data"), et_password.getText().toString()));
            ...
            Call<GsonRegister> call = request.getJSON(params, fileToUpload);
...
//                    GsonRegister jsonResponse = response.body();
                    ...
                    if (gson.getFlag().equals(1)) {
                        ...
                        dataregister.add(response.body().getData());
